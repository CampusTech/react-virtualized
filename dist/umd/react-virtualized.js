!function(global, factory) {
    ...
    function _callSuper(t, o, e) {
        o = _getPrototypeOf(o);
        var self = t, o = _isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e);
        if (o && ("object" == typeof o || "function" == typeof o)) return o;
    ...
    function _objectWithoutProperties(source, excluded) {
        ...
        var key, target = function(source, excluded) {
            if (null == source) return {};
            var key, target = {};
            for (key in source) !Object.prototype.hasOwnProperty.call(source, key) || 0 <= excluded.indexOf(key) || (target[key] = source[key]);
            return target;
        }(source, excluded);
   ...
   */();
    ...
    function polyfill(Component) {
        ...
        if ("function" == typeof Component.getDerivedStateFromProps || "function" == typeof prototype.getSnapshotBeforeUpdate) {
            ...
            var componentName, newApiName, foundWillMountName = null, foundWillReceivePropsName = null, foundWillUpdateName = null;
    ...
    var ArrowKeyStepper = function() {
        ...
        return _inherits(ArrowKeyStepper, React.PureComponent), _createClass(ArrowKeyStepper, [ {
            ...
            value: function(_ref2) {
                var scrollToColumn = _ref2.scrollToColumn, _ref2 = _ref2.scrollToRow;
                this.setState({
                    scrollToRow: _ref2,
                    scrollToColumn: scrollToColumn
                });
            ...
            key: "render",
            value: function() {
                var _this$props2 = this.props, className = _this$props2.className, _this$props2 = _this$props2.children, _this$_getScrollState3 = this._getScrollState(), scrollToColumn = _this$_getScrollState3.scrollToColumn, _this$_getScrollState3 = _this$_getScrollState3.scrollToRow;
                return React.createElement("div", {
                    ...
                    scrollToColumn: scrollToColumn,
                    scrollToRow: _this$_getScrollState3
                }));
            }
        }, {
            key: "_getScrollState",
    ...
    var AutoSizer = function() {
        ...
        return _inherits(AutoSizer, React.Component), _createClass(AutoSizer, [ {
            ...
            key: "render",
            value: function() {
                var _this$props2 = this.props, children = _this$props2.children, className = _this$props2.className, disableHeight = _this$props2.disableHeight, disableWidth = _this$props2.disableWidth, _this$props2 = _this$props2.style, _this$state = this.state, height = _this$state.height, _this$state = _this$state.width, outerStyle = {
                    overflow: "visible"
                }, childParams = {};
                return disableHeight || (outerStyle.height = 0, childParams.height = height), 
                disableWidth || (outerStyle.width = 0, childParams.width = _this$state), 
                React.createElement("div", {
                    className: className,
                    ref: this._setRef,
                    style: _objectSpread2(_objectSpread2({}, outerStyle), _this$props2)
        ...
        function CellMeasurer() {
            ...
            for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
            return _defineProperty(_this = _callSuper(this, CellMeasurer, [].concat(args)), "_child", void 0), 
        ...
        return _inherits(CellMeasurer, React.PureComponent), _createClass(CellMeasurer, [ {
            ...
            value: function() {
                var styleWidth, styleHeight, width, cache = this.props.cache, node = this._child || reactDom.findDOMNode(this);
    ...
    CellMeasurer.__internalCellMeasurerFlag = !0, _createClass(function CellMeasurerCache() {
        ...
        }), params.defaultHeight), defaultWidth = params.defaultWidth, fixedHeight = params.fixedHeight, fixedWidth = params.fixedWidth, keyMapper = params.keyMapper, minHeight = params.minHeight, params = params.minWidth;
        this._hasFixedHeight = !0 === fixedHeight, this._hasFixedWidth = !0 === fixedWidth, 
        this._minHeight = minHeight || 0, this._minWidth = params || 0, this._keyMapper = keyMapper || defaultKeyMapper, 
    ...
    reactIs_development.isConcurrentMode, reactIs_development.isContextConsumer, 
    ...
    reactIs_development.isSuspense, reactIs_development.isValidElementType, reactIs_development.typeOf, 
   ...
   */
    ...
    var SCROLL_POSITION_CHANGE_REASONS_OBSERVED = "observed", SCROLL_POSITION_CHANGE_REASONS_REQUESTED = "requested", CollectionView = function() {
        function CollectionView() {
            ...
            _defineProperty(_this, "_invokeOnSectionRenderedHelper", function() {
                var _this$props = _this.props, cellLayoutManager = _this$props.cellLayoutManager, _this$props = _this$props.onSectionRendered;
        ...
        return _inherits(CollectionView, React.PureComponent), _createClass(CollectionView, [ {
            ...
            value: function() {
                ...
                }), this._invokeOnSectionRenderedHelper(), cellLayoutManager.getTotalSize()), cellLayoutManager = scrollToCell.height, scrollToCell = scrollToCell.width;
                this._invokeOnScrollMemoizer({
                    scrollLeft: scrollLeft || 0,
                    scrollTop: _this$props4 || 0,
                    totalHeight: cellLayoutManager,
                    totalWidth: scrollToCell
                });
            }
        }, {
            key: "componentDidUpdate",
            value: function(prevProps, prevState) {
                var _this$props5 = this.props, height = _this$props5.height, scrollToAlignment = _this$props5.scrollToAlignment, scrollToCell = _this$props5.scrollToCell, _this$props5 = _this$props5.width, _this$state2 = this.state, scrollLeft = _this$state2.scrollLeft, scrollPositionChangeReason = _this$state2.scrollPositionChangeReason, _this$state2 = _this$state2.scrollTop;
                ...
                0 <= _this$state2) && _this$state2 !== prevState.scrollTop && _this$state2 !== this._scrollingContainer.scrollTop && (this._scrollingContainer.scrollTop = _this$state2), 
            ...
            value: function(_ref) {
                ...
                this._onScrollMemoizer({
                    callback: function(_ref2) {
                        var scrollLeft = _ref2.scrollLeft, _ref2 = _ref2.scrollTop, _this3$props = _this3.props, height = _this3$props.height;
        ...
        key: "getCellIndices",
        value: function(_ref) {
            var height = _ref.height, width = _ref.width, x = _ref.x, _ref = _ref.y, indices = {};
    ...
    var Collection = function() {
        ...
        return _inherits(Collection, React.PureComponent), _createClass(Collection, [ {
            ...
            key: "render",
            value: function() {
                var props = _extends({}, (function(obj) {
            ...
            value: function() {
                var _this$props = this.props, _this$props = function(_ref) {
                    for (var cellCount = _ref.cellCount, cellSizeAndPositionGetter = _ref.cellSizeAndPositionGetter, _ref = _ref.sectionSize, cellMetadata = [], sectionManager = new SectionManager(_ref), height = 0, width = 0, index = 0; index < cellCount; index++) {
            ...
            value: function(_ref) {
                var align = _ref.align, cellIndex = _ref.cellIndex, height = _ref.height, scrollLeft = _ref.scrollLeft, scrollTop = _ref.scrollTop, _ref = _ref.width, cellCount = this.props.cellCount;
            ...
            key: "cellRenderers",
            value: function(_ref2) {
                var _this2 = this, height = _ref2.height, isScrolling = _ref2.isScrolling, width = _ref2.width, x = _ref2.x, _ref2 = _ref2.y, _this$props2 = this.props, cellGroupRenderer = _this$props2.cellGroupRenderer, _this$props2 = _this$props2.cellRenderer;
    ...
    var ColumnSizer = function() {
        ...
        return _inherits(ColumnSizer, React.PureComponent), _createClass(ColumnSizer, [ {
            ...
            value: function(prevProps) {
                var _this$props = this.props, columnMaxWidth = _this$props.columnMaxWidth, columnMinWidth = _this$props.columnMinWidth, columnCount = _this$props.columnCount, _this$props = _this$props.width;
                columnMaxWidth === prevProps.columnMaxWidth && columnMinWidth === prevProps.columnMinWidth && columnCount === prevProps.columnCount && _this$props === prevProps.width || this._registeredChild && this._registeredChild.recomputeGridSize();
            }
        }, {
            key: "render",
            value: function() {
                var _this$props2 = this.props, children = _this$props2.children, columnMaxWidth = _this$props2.columnMaxWidth, columnMinWidth = _this$props2.columnMinWidth, columnCount = _this$props2.columnCount, _this$props2 = _this$props2.width, columnMinWidth = columnMinWidth || 1, columnMaxWidth = columnMaxWidth ? Math.min(columnMaxWidth, _this$props2) : _this$props2, columnWidth = _this$props2 / columnCount, columnWidth = Math.max(columnMinWidth, columnWidth);
                return columnWidth = Math.min(columnMaxWidth, columnWidth), columnWidth = Math.floor(columnWidth), 
                children({
                    adjustedWidth: Math.min(_this$props2, columnWidth * columnCount),
    ...
    function calculateSizeAndPositionDataAndUpdateScrollOffset(_ref) {
        var cellCount = _ref.cellCount, cellSize = _ref.cellSize, computeMetadataCallback = _ref.computeMetadataCallback, computeMetadataCallbackProps = _ref.computeMetadataCallbackProps, nextCellsCount = _ref.nextCellsCount, nextCellSize = _ref.nextCellSize, nextScrollToIndex = _ref.nextScrollToIndex, scrollToIndex = _ref.scrollToIndex, _ref = _ref.updateScrollOffsetForScrollToIndex;
        ...
        0 <= scrollToIndex && scrollToIndex === nextScrollToIndex && _ref());
    }
    ...
    var CellSizeAndPositionManager = _createClass(function CellSizeAndPositionManager(_ref) {
        ...
        value: function(_ref3) {
            var _ref3$align = _ref3.align, _ref3$align = void 0 === _ref3$align ? "auto" : _ref3$align, containerSize = _ref3.containerSize, currentOffset = _ref3.currentOffset, _ref3 = _ref3.targetIndex;
            if (containerSize <= 0) return 0;
            var idealOffset, datum = this.getSizeAndPositionOfCell(_ref3), maxOffset = datum.offset, minOffset = maxOffset - containerSize + datum.size;
            switch (_ref3$align) {
              case "start":
        ...
        key: "getUpdatedOffsetForIndex",
        value: function(_ref3) {
            var _ref3$align = _ref3.align, _ref3$align = void 0 === _ref3$align ? "auto" : _ref3$align, containerSize = _ref3.containerSize, currentOffset = _ref3.currentOffset, _ref3 = _ref3.targetIndex, currentOffset = this._safeOffsetToOffset({
                containerSize: containerSize,
        ...
        key: "getVisibleCellRange",
        value: function(_ref4) {
            var containerSize = _ref4.containerSize, _ref4 = _ref4.offset, _ref4 = this._safeOffsetToOffset({
                containerSize: containerSize,
                offset: _ref4
            });
        ...
        value: function(_ref5) {
            var containerSize = _ref5.containerSize, offset = _ref5.offset, _ref5 = _ref5.totalSize;
            return _ref5 <= containerSize ? 0 : offset / (_ref5 - containerSize);
        }
    }, {
    ...
    function defaultOverscanIndicesGetter(_ref) {
        var cellCount = _ref.cellCount, overscanCellsCount = _ref.overscanCellsCount, scrollDirection = _ref.scrollDirection, startIndex = _ref.startIndex, _ref = _ref.stopIndex;
        return 1 === scrollDirection ? {
            overscanStartIndex: Math.max(0, startIndex),
            overscanStopIndex: Math.min(cellCount - 1, _ref + overscanCellsCount)
        } : {
            overscanStartIndex: Math.max(0, startIndex - overscanCellsCount),
            overscanStopIndex: Math.min(cellCount - 1, _ref)
        };
    }
    ...
    function defaultCellRangeRenderer(_ref) {
        for (var cellCache = _ref.cellCache, cellRenderer = _ref.cellRenderer, columnSizeAndPositionManager = _ref.columnSizeAndPositionManager, columnStartIndex = _ref.columnStartIndex, columnStopIndex = _ref.columnStopIndex, deferredMeasurementCache = _ref.deferredMeasurementCache, horizontalOffsetAdjustment = _ref.horizontalOffsetAdjustment, isScrolling = _ref.isScrolling, isScrollingOptOut = _ref.isScrollingOptOut, parent = _ref.parent, rowSizeAndPositionManager = _ref.rowSizeAndPositionManager, rowStartIndex = _ref.rowStartIndex, rowStopIndex = _ref.rowStopIndex, styleCache = _ref.styleCache, verticalOffsetAdjustment = _ref.verticalOffsetAdjustment, visibleColumnIndices = _ref.visibleColumnIndices, visibleRowIndices = _ref.visibleRowIndices, renderedCells = [], _ref = columnSizeAndPositionManager.areOffsetsAdjusted() || rowSizeAndPositionManager.areOffsetsAdjusted(), canCacheStyle = !isScrolling && !_ref, rowIndex = rowStartIndex; rowIndex <= rowStopIndex; rowIndex++) for (var rowDatum = rowSizeAndPositionManager.getSizeAndPositionOfCell(rowIndex), columnIndex = columnStartIndex; columnIndex <= columnStopIndex; columnIndex++) {
            ...
            cellCache[key])) && !1 !== isVisible && (!function(parent, renderedCell) {
    ...
    var win, request = (win = "undefined" != typeof window ? window : "undefined" != typeof self ? self : {}).requestAnimationFrame || win.webkitRequestAnimationFrame || win.mozRequestAnimationFrame || win.oRequestAnimationFrame || win.msRequestAnimationFrame || function(callback) {
        ...
        win.clearTimeout(id);
    }, raf = request, caf = cancel, SCROLL_POSITION_CHANGE_REASONS$1_OBSERVED = "observed", SCROLL_POSITION_CHANGE_REASONS$1_REQUESTED = "requested", Grid = function() {
        function Grid(props) {
        ...
        return _inherits(Grid, React.PureComponent), _createClass(Grid, [ {
            ...
            value: function(_ref6) {
                ...
                this._onScrollMemoizer({
                    callback: function(_ref7) {
                        var scrollLeft = _ref7.scrollLeft, _ref7 = _ref7.scrollTop, _this3$props = _this3.props, height = _this3$props.height;
                        (0, _this3$props.onScroll)({
                            clientHeight: height,
                            clientWidth: _this3$props.width,
            ...
            value: function(_ref8) {
                var scrollLeft = _ref8.scrollLeft, _ref8 = _ref8.scrollTop, scrollLeft = Grid._getScrollToPositionStateUpdate({
                    prevState: this.state,
                    scrollLeft: scrollLeft,
                    scrollTop: _ref8
                });
    ...
    request = function() {
        ...
        return _inherits(InfiniteLoader, React.PureComponent), _createClass(InfiniteLoader, [ {
            ...
            value: function(unloadedRanges) {
                ...
                unloadedRanges.forEach(function(unloadedRange) {
                    ...
                    promise && promise.then(function() {
                        var _ref4, lastRenderedStartIndex, lastRenderedStopIndex, startIndex;
                        _ref4 = {
                        ...
                        lastRenderedStopIndex = _ref4.lastRenderedStopIndex, startIndex = _ref4.startIndex, 
                        _ref4 = _ref4.stopIndex, lastRenderedStopIndex < startIndex || _ref4 < lastRenderedStartIndex || _this2._registeredChild && function(component) {
            ...
            value: function(startIndex, stopIndex) {
                var _this3 = this, _this$props = this.props, isRowLoaded = _this$props.isRowLoaded, minimumBatchSize = _this$props.minimumBatchSize, rowCount = _this$props.rowCount, _this$props = _this$props.threshold, unloadedRanges = function(_ref5) {
                    ...
                    rowCount: rowCount,
                    startIndex: Math.max(0, startIndex - _this$props),
                    stopIndex: Math.min(rowCount - 1, stopIndex + _this$props)
                }), minimumBatchSize = (isRowLoaded = []).concat.apply(isRowLoaded, _toConsumableArray(unloadedRanges.map(function(_ref3) {
                ...
                this._loadMoreRowsMemoizer({
                    ...
                    indices: {
                        squashedUnloadedRanges: minimumBatchSize
                    }
                });
            }
        }, {
    ...
    cancel = function() {
        function List() {
            ...
            _defineProperty(_this, "_cellRenderer", function(_ref) {
                ...
                var clientHeight = _ref2.clientHeight, scrollHeight = _ref2.scrollHeight, _ref2 = _ref2.scrollTop;
                ...
                var rowOverscanStartIndex = _ref3.rowOverscanStartIndex, rowOverscanStopIndex = _ref3.rowOverscanStopIndex, rowStartIndex = _ref3.rowStartIndex, _ref3 = _ref3.rowStopIndex;
        ...
        return _inherits(List, React.PureComponent), _createClass(List, [ {
            ...
            key: "getOffsetForRow",
            value: function(_ref4) {
                var alignment = _ref4.alignment, _ref4 = _ref4.index;
            ...
            key: "invalidateCellSizeAfterRender",
            value: function(_ref5) {
                var columnIndex = _ref5.columnIndex, _ref5 = _ref5.rowIndex;
    ...
    var PositionCache = _createClass(function PositionCache() {
        ...
        value: function(scrollTop, clientHeight, renderCallback) {
            ...
            this._intervalTree.queryInterval(scrollTop, scrollTop + clientHeight, function(_ref) {
                var _ref = _slicedToArray(_ref, 3), top = _ref[0], _ref = (_ref[1], 
                _ref[2]);
        ...
        return _inherits(Masonry, React.PureComponent), _createClass(Masonry, [ {
            ...
            value: function() {
                var _this$props2 = this.props, cellCount = _this$props2.cellCount, cellMeasurerCache = _this$props2.cellMeasurerCache, _this$props2 = _this$props2.width, _this$props2 = Math.max(1, Math.floor(_this$props2 / cellMeasurerCache.defaultWidth));
            ...
            value: function(startIndex, stopIndex) {
                for (var _this$props4 = this.props, cellMeasurerCache = _this$props4.cellMeasurerCache, cellPositioner = _this$props4.cellPositioner, _index2 = startIndex; _index2 <= stopIndex; _index2++) {
                    var _cellPositioner = cellPositioner(_index2), left = _cellPositioner.left, _cellPositioner = _cellPositioner.top;
                    this._positionCache.setPosition(_index2, left, _cellPositioner, cellMeasurerCache.getHeight(_index2));
                }
            }
        } ], [ {
            key: "getDerivedStateFromProps",
    ...
    var CellMeasurerCacheDecorator = _createClass(function CellMeasurerCacheDecorator() {
        ...
        function MultiGrid(props, context) {
            ...
            _defineProperty(_this, "_deferredInvalidateRowIndex", null), _defineProperty(_this, "_bottomLeftGridRef", function(ref) {
                ...
                var columnIndex = _ref3.columnIndex, _ref3 = _objectWithoutProperties(_ref3, _excluded3), _this$props3 = _this.props, cellRenderer = _this$props3.cellRenderer, columnCount = _this$props3.columnCount, _this$props3 = _this$props3.fixedColumnCount;
                return columnIndex === columnCount - _this$props3 ? React.createElement("div", {
                    key: _ref3.key,
                    style: _objectSpread2(_objectSpread2({}, _ref3.style), {}, {
                        width: 20
                    })
                }) : cellRenderer(_objectSpread2(_objectSpread2({}, _ref3), {}, {
                    columnIndex: columnIndex + _this$props3,
                    parent: _this
                }));
                ...
                var scrollLeft = scrollInfo.scrollLeft, scrollTop = scrollInfo.scrollTop, scrollLeft = (_this.setState({
                    scrollLeft: scrollLeft,
                    scrollTop: scrollTop
                }), _this.props.onScroll);
                scrollLeft && scrollLeft(scrollInfo);
            }), _defineProperty(_this, "_onScrollbarPresenceChange", function(_ref5) {
                var horizontal = _ref5.horizontal, size = _ref5.size, _ref5 = _ref5.vertical, _this$state2 = _this.state, showHorizontalScrollbar = _this$state2.showHorizontalScrollbar, _this$state2 = _this$state2.showVerticalScrollbar;
                horizontal === showHorizontalScrollbar && _ref5 === _this$state2 || (_this.setState({
                    scrollbarSize: size,
                    showHorizontalScrollbar: horizontal,
                    showVerticalScrollbar: _ref5
                }), "function" == typeof (showHorizontalScrollbar = _this.props.onScrollbarPresenceChange) && showHorizontalScrollbar({
                ...
                var _ref6 = _ref6.index, _this$props5 = _this.props, fixedRowCount = _this$props5.fixedRowCount, rowCount = _this$props5.rowCount, _this$props5 = _this$props5.rowHeight, _this$state3 = _this.state, scrollbarSize = _this$state3.scrollbarSize;
                return _this$state3.showVerticalScrollbar && _ref6 === rowCount - fixedRowCount ? scrollbarSize : "function" == typeof _this$props5 ? _this$props5({
        ...
        return _inherits(MultiGrid, React.PureComponent), _createClass(MultiGrid, [ {
            ...
            key: "render",
            value: function() {
                var scrollLeft, _this$state4, _this$props8 = this.props, onScroll = _this$props8.onScroll, onSectionRendered = _this$props8.onSectionRendered, scrollToColumn = (_this$props8.onScrollbarPresenceChange, 
                _this$props8.scrollLeft, _this$props8.scrollToColumn), scrollToRow = (_this$props8.scrollTop, 
                _this$props8.scrollToRow), _this$props8 = _objectWithoutProperties(_this$props8, _excluded4);
        ...
        return _inherits(ScrollSync, React.PureComponent), _createClass(ScrollSync, [ {
            key: "render",
            value: function() {
                var children = this.props.children, _this$state = this.state, clientHeight = _this$state.clientHeight, clientWidth = _this$state.clientWidth, scrollHeight = _this$state.scrollHeight, scrollLeft = _this$state.scrollLeft, scrollTop = _this$state.scrollTop, _this$state = _this$state.scrollWidth;
                return children({
                    clientHeight: clientHeight,
                    ...
                    scrollLeft: scrollLeft,
                    scrollTop: scrollTop,
                    scrollWidth: _this$state
                });
            }
        }, {
            key: "_onScroll",
            value: function(_ref) {
                var clientHeight = _ref.clientHeight, clientWidth = _ref.clientWidth, scrollHeight = _ref.scrollHeight, scrollLeft = _ref.scrollLeft, scrollTop = _ref.scrollTop, _ref = _ref.scrollWidth;
                this.setState({
                    clientHeight: clientHeight,
                    clientWidth: clientWidth,
                    scrollHeight: scrollHeight,
    ...
    function defaultHeaderRowRenderer(_ref) {
        var className = _ref.className, columns = _ref.columns, _ref = _ref.style;
        return React.createElement("div", {
            className: className,
            role: "row",
            style: _ref
    ...
    function defaultHeaderRenderer(_ref) {
        var dataKey = _ref.dataKey, label = _ref.label, sortBy = _ref.sortBy, _ref = _ref.sortDirection, sortBy = sortBy === dataKey, dataKey = [ React.createElement("span", {
            className: "ReactVirtualized__Table__headerTruncatedText",
            key: "label",
            title: "string" == typeof label ? label : null
        }, label) ];
        return sortBy && dataKey.push(React.createElement(SortIndicator, {
            key: "SortIndicator",
            sortDirection: _ref
        })), dataKey;
    }
    ...
    var Column = function() {
        ...
        function Table(props) {
            ...
            props._setRef = props._setRef.bind(props), props;
        }
        return _inherits(Table, React.PureComponent), _createClass(Table, [ {
            ...
            key: "getOffsetForRow",
            value: function(_ref) {
                var alignment = _ref.alignment, _ref = _ref.index;
                return this.Grid ? this.Grid.getOffsetForCell({
                    alignment: alignment,
                    rowIndex: _ref
                }).scrollTop : 0;
            ...
            key: "invalidateCellSizeAfterRender",
            value: function(_ref2) {
                var columnIndex = _ref2.columnIndex, _ref2 = _ref2.rowIndex;
                this.Grid && this.Grid.invalidateCellSizeAfterRender({
                    rowIndex: _ref2,
                    columnIndex: columnIndex
                });
            ...
            value: function() {
                ...
                return this.Grid ? (clientWidth = (_Grid = this.Grid._scrollingContainer).clientWidth || 0, 
            ...
            value: function() {
                ...
                return this._cachedColumnStyles = [], React.Children.toArray(children).forEach(function(column, index) {
                    column = _this2._getFlexStyleForColumn(column, column.props.style);
            ...
            key: "_onScroll",
            value: function(_ref7) {
                var clientHeight = _ref7.clientHeight, scrollHeight = _ref7.scrollHeight, _ref7 = _ref7.scrollTop;
            ...
            value: function(_ref8) {
                var rowOverscanStartIndex = _ref8.rowOverscanStartIndex, rowOverscanStopIndex = _ref8.rowOverscanStopIndex, rowStartIndex = _ref8.rowStartIndex, _ref8 = _ref8.rowStopIndex;
    ...
    propTypes = function() {
        ...
        return _inherits(WindowScroller, React.PureComponent), _createClass(WindowScroller, [ {
            ...
            key: "render",
            value: function() {
                var children = this.props.children, _this$state2 = this.state, isScrolling = _this$state2.isScrolling, scrollTop = _this$state2.scrollTop, scrollLeft = _this$state2.scrollLeft, height = _this$state2.height, _this$state2 = _this$state2.width;
                return React.createElement("div", {
